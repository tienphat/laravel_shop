...
<html lang="en">
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="{{url('/dashboard')}}" class="site_title"><i class="fa fa-paw"></i> <span>Giant Shop!</span></a>
                        </div>
                        ...
                        <div class="profile">
                            <div class="profile_pic">
                                <img src="{{url('/')}}/public/images/{{Auth::user()->image}}" alt="{{Auth::user()->fullname}}" class="img-circle profile_img">
                            </div>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li>
                                        <a><i class="fa fa-table"></i> Products <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav child_menu">
                                            ...
                                            <li><a href="{{url('admin/backup')}}">Backup</a></li>
                                        </ul>
                                    </li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <img src="{{url('/')}}/public/images/{{Auth::user()->image}}" alt="{{Auth::user()->fullname}}">{{Auth::user()->fullname}}
    ...
    var data1 = [
                    [gd(2012, 1, 1), 17],
                    [gd(2012, 1, 2), 74],         [gd(2012, 1, 3), 6],         [gd(2012, 1, 4), 39],         [gd(2012, 1, 5), 20],         [gd(2012, 1, 6), 85],         [gd(2012, 1, 7), 7]
    ];
    ...
    var data2 = [
        ...
        <script>
                ...
                var cb = function (start, end, label) {
                    console.log(start.toISOString(), end.toISOString(), label);                     $('#reportrange span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
                };
