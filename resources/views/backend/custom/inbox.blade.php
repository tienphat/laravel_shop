...
<html lang="en">
  <head>
    ...
    <!-- bootstrap-wysiwyg -->
    <link href="libs/google-code-prettify/bin/prettify.min.css" rel="stylesheet">
  ...
  <body class="nav-md">
    ...
    <!-- bootstrap-wysiwyg -->
    <script src="libs/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js"></script>
    <script src="libs/jquery.hotkeys/jquery.hotkeys.js"></script>
    <script src="libs/google-code-prettify/src/prettify.js"></script>
